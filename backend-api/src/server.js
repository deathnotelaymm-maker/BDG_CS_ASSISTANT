...
const API_VERSION = '1.15.4-prompt-runtime-versioning-repair';
const API_FEATURES = ['tenant-core','platform-control-center','platform-scoped-admin','tenant-data-isolation','platform-context-header','platform-context-no-fallback','platform-context-lock','platform-resolution-diagnostics','reject-missing-platform-context','platform-admin-users','automatic-platform-access-links','custom-domain-safety','domain-mapping-tenant-join-repair','tenant-role-boundaries','platform-domain-registry','platform-feature-entitlements','legacy-content-backfill','advanced-knowledge-import','xlsx-draft-review','multi-platform-support-router','ticket-capability-guard','ai-knowledge-orchestrator-v4','prompt-first-one-call','immutable-prompt-runtime-versions','compiled-prompt-hash','prompt-aware-memory-reset','fresh-admin-prompt-test','prompt-runtime-diagnostics','current-deepseek-v4-model','matched-source-image-delivery','live-provider-connectivity-test','backend-keyword-scoring-disabled','multilingual-visual-knowledge','structured-rich-response-v2','visual-guide-studio','action-buttons','durable-site-content-delete','unified-content-versions','chat-start-module','experience-studio','safe-animation-presets','platform-chat-layout','r2-s3-api','operations-connector-gateway','platform-connector-allowlist','connector-test-connection','connector-audit-trail','redacted-operation-logs','qualified-membership-permissions','owner-scoped-support-platform','arbitrary-platform-locales','local-brand-uploads','chat-start-preview-controls','one-platform-guard','strict-public-platform-route','neutral-route-presentation','quick-reply-one-time','ai-qa-source','rich-faq-studio','import-approval-publish','locale-aware-knowledge-studio','locale-policy','locale-coverage','faq-sql-repair','platform-locale-registry','unified-ai-source-router','source-policy-controls','source-aware-diagnostics','dynamic-ai-locale-routing','default-locale-source-fallback','production-domain-mapping','generated-platform-routes','custom-domain-verification','ai-reliability-foundation','bounded-provider-retries','turn-deadline-budget','verified-source-fallback','local-conversation-safety','customer-safe-degraded-response','platform-rate-limits','neutral-ai-fallback','multilingual-admin-help','chat-platform-route-propagation','chat-body-platform-context','platform-context-mismatch-rejection','byod-domain-mapping','cloudflare-custom-hostnames','custom-hostname-ssl-readiness','hostname-platform-resolution','dynamic-custom-hostname-cors','single-image-delivery','step-aware-image-rendering','canonical-response-blocks','legacy-image-fallback','domain-id-validation','cloudflare-configuration-guard','guide-parent-publication-sync','guide-derived-publication-status','guide-platform-self-service-upload','guide-publish-role-guard','guide-media-ownership-audit','guide-motion-media','guide-gif-covers','guide-video-autoplay-loop','guide-safe-text-animation-presets','guide-reduced-motion','ai-response-quality-center','immutable-file-migrations','server-rich-html-sanitization','connector-dns-ssrf-guard','postgres-api-integration-tests'];
