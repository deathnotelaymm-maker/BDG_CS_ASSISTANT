...
const checks = [
  ['v1.7 release marker is aligned', core.includes('1.7.0-strict-tenant-routing-quick-reply-lifecycle') && server.includes('1.7.0-strict-tenant-routing-quick-reply-lifecycle')],
