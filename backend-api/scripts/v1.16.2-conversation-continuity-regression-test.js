...
test('v1.16.2 release marker is active', core.includes('1.17.3-support-workspace-ux-admin-access-tenant-isolation') && server.includes('1.17.3-support-workspace-ux-admin-access-tenant-isolation'));
