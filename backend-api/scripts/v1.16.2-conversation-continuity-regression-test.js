...
test('v1.16.2 release marker is active', core.includes('1.17.4-cs-identity-domain-promotion-menu-upgrade') && server.includes('1.17.4-cs-identity-domain-promotion-menu-upgrade'));
