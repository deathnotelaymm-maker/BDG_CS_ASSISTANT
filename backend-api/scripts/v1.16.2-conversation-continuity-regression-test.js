...
test('v1.16.2 release marker is active', core.includes('1.17.2-luke-shared-hosting-platform-route') && server.includes('1.17.2-luke-shared-hosting-platform-route'));
