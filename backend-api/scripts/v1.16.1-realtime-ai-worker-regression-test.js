...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.17.1-verified-domain-mapping-dynamic-cors') && server.includes('1.17.1-verified-domain-mapping-dynamic-cors'));
