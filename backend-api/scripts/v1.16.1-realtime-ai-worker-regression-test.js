...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.17.0-professional-support-workspace-chat-media') && server.includes('1.17.0-professional-support-workspace-chat-media'));
