...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.17.2-luke-shared-hosting-platform-route') && server.includes('1.17.2-luke-shared-hosting-platform-route'));
