...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.17.3-support-workspace-ux-admin-access-tenant-isolation') && server.includes('1.17.3-support-workspace-ux-admin-access-tenant-isolation'));
