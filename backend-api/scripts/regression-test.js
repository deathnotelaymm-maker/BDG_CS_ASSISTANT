...
expect("Backend and server retain the SSE delivery runtime on the current release", core.includes("1.17.3-support-workspace-ux-admin-access-tenant-isolation") && server.includes("1.17.3-support-workspace-ux-admin-access-tenant-isolation"));
...
expect("Admin release marker is v1.17.3", adminLayout.includes('const ADMIN_VERSION = "v1.17.3"'));
