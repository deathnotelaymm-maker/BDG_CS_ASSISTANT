...
expect("Backend and server retain the SSE delivery runtime on the current release", core.includes("1.17.4-cs-identity-domain-promotion-menu-upgrade") && server.includes("1.17.4-cs-identity-domain-promotion-menu-upgrade"));
...
expect("Admin release marker is v1.17.4", adminLayout.includes('const ADMIN_VERSION = "v1.17.4"'));
