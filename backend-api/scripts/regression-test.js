...
expect("Backend and server expose the v1.16.4 SSE delivery runtime", core.includes("1.16.4-sse-customer-delivery-durable-queue") && server.includes("1.16.4-sse-customer-delivery-durable-queue"));
...
expect("Admin release marker is v1.16.4", adminLayout.includes('const ADMIN_VERSION = "v1.16.4"'));
