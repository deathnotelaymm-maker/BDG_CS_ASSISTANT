...
expect("Backend and server expose the v1.16.3 admin/chat/theme runtime", core.includes("1.16.3-admin-contract-chat-flow-theme-separation") && server.includes("1.16.3-admin-contract-chat-flow-theme-separation"));
...
expect("Admin release marker is v1.16.3", adminLayout.includes('const ADMIN_VERSION = "v1.16.3"'));
