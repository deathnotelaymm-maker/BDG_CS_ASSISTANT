...
expect("Backend and server expose the v1.16.4 SSE delivery runtime", core.includes("1.17.0-professional-support-workspace-chat-media") && server.includes("1.17.0-professional-support-workspace-chat-media"));
...
expect("Admin release marker is v1.17.0", adminLayout.includes('const ADMIN_VERSION = "v1.17.0"'));
