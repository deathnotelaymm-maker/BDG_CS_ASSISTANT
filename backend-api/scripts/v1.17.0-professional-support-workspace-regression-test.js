...
const checks=[
 ['v1.17.0 release marker is active',core.includes('1.17.0-professional-support-workspace-chat-media')&&server.includes('1.17.0-professional-support-workspace-chat-media')],
