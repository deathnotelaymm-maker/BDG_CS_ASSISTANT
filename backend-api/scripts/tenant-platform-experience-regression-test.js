...
const checks = [
  ['Release version is aligned', core.includes('1.9.0-locale-aware-knowledge-studio') && server.includes('1.9.0-locale-aware-knowledge-studio')],
  ...
  ['Admin identity/version is visible', layout.includes('Luke Admin Control') && layout.includes('AI') && layout.includes('v1.9.0')],
];
