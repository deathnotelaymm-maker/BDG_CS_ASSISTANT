...
const checks = [
  ['Release version is aligned', core.includes('1.7.0-strict-tenant-routing-quick-reply-lifecycle') && server.includes('1.7.0-strict-tenant-routing-quick-reply-lifecycle')],
  ...
  ['Admin identity/version is visible', layout.includes('Luke Admin Control') && layout.includes('AI') && layout.includes('v1.7.0')],
];
