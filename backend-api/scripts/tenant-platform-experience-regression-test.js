...
const checks = [
  ['Release version is aligned', core.includes('1.6.0-tenant-experience-studio-resilient-knowledge-import') && server.includes('1.6.0-tenant-experience-studio-resilient-knowledge-import')],
  ...
  ['Admin identity/version is visible', layout.includes('Luke Admin Control') && layout.includes('AI') && layout.includes('v1.6.0')],
];
