...
const checks = [
  ['Release version is aligned', core.includes('1.8.0-ai-qa-rich-faq-studio') && server.includes('1.8.0-ai-qa-rich-faq-studio')],
  ...
  ['Admin identity/version is visible', layout.includes('Luke Admin Control') && layout.includes('AI') && layout.includes('v1.8.0')],
];
