...
const checks = [
  ['Operations Connector version marker', core.includes('1.5.0-tenant-platform-experience-owner-controls') && server.includes('1.5.0-tenant-platform-experience-owner-controls')],
