...
try{
  ...
  & (Join-Path $ProjectRoot 'VERIFY-V0.10.0-WINDOWS.ps1') -ApiBaseUrl $ApiBaseUrl
  ...
  & (Join-Path $ProjectRoot 'VERIFY-V0.10.0-WINDOWS.ps1') -ApiBaseUrl $ApiBaseUrl -VerifyPages
}finally{Pop-Location}
Write-Host 'v0.10.0 production deployment completed successfully.' -ForegroundColor Green
