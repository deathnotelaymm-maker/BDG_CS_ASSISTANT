...
Deploy-ProPage "guide-pro" "bdg-guide-pages" "Guide Pro v0.6.7"
Deploy-ProPage "chat-pro" "bdg-chat-pages" "Chat Pro v0.6.7"
Deploy-ProPage "admin-pro" "bdg-admin-pages" "Admin Pro v0.6.7"

Write-Host "" 
Write-Host "Pro Pages v0.6.7 deployed." -ForegroundColor Green
