...
Deploy-ProPage "guide-pro" "bdg-guide-pages" "Guide Pro v0.6.8"
Deploy-ProPage "chat-pro" "bdg-chat-pages" "Chat Pro v0.6.8"
Deploy-ProPage "admin-pro" "bdg-admin-pages" "Admin Pro v0.6.8"

Write-Host "" 
Write-Host "Pro Pages v0.6.8 deployed." -ForegroundColor Green
