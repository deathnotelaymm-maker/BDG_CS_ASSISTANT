...
Write-Host $health
if ($health -notmatch '0\.5\.8-worker') {
  throw "Worker deploy did not update to v0.5.8-worker. Check the Wrangler output above."
}
Set-Location $Root
Write-Host "Worker v0.5.8 deployed successfully." -ForegroundColor Green
