...
const NAV: { key: string; to: string; label: string; icon: ReactNode; group?: string }[] = [
  ...
  },
  {
    ...
    label: "AI Response Quality Center",
...
const ZH: Record<string, string> = {
  ...
  "AI Response Quality Center": "AI 回复质量中心",
