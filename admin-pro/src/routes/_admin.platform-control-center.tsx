      ...
      {detailLoading && !selected ? <Spin /> : selected && <>
        ...
        <Tabs items={[
          ...
          { key: "access-links", label: "Platform access links", children: <>
            <Alert type="success" showIcon message="Ready to share immediately" description="These generated URLs use your Luke shared hosting sites. They are not client-owned custom DNS domains." style={{ marginBottom: 16 }} />
